...
const navItems = [
  { name: "Redes Sociales", href: "/analytics", icon: BarChart3 },
  { name: "Reseñas Google", href: "/google-reviews", icon: Activity },
  { name: "Chatbot", href: "/chatbot", icon: MessageSquare },
  { name: "Comentarios Redes Sociales", href: "/comments", icon: MessageSquare },
